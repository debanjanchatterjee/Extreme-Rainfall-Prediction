...
files=['RFone_imd_rf_1x1_1997.nc', 'RFone_imd_rf_1x1_1998.nc', 'RFone_imd_rf_1x1_1999.nc', 'RFone_imd_rf_1x1_2000.nc']
...
for item in files:
    ...
    emptydf.to_csv('1997-2000_yvalue_mumbai.csv',index=False)